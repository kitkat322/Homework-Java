...
//    вміють навчатися, читати, писати, відпочивати.
    ...
    @Override
    public void study() {
        System.out.println("Excellent level of studying");
    }

    @Override
    public void read() {
        System.out.println("Excellent level of reading");
    }

    @Override
    public void write() {
        System.out.println("Excellent level of writing");
    }

    @Override
    public void relax() {
        System.out.println("Doesn`t much relax");
    }
}
