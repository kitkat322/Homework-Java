...
//    вміють навчатися, читати, писати, відпочивати.
    ...
    @Override
    public void study() {
        System.out.println("Good level of studying");
    }

    @Override
    public void read() {
        System.out.println("Good level of reading");
    }

    @Override
    public void write() {
        System.out.println("Good level of writing");
    }

    @Override
    public void relax() {
        System.out.println("Enough relax");
    }
}
